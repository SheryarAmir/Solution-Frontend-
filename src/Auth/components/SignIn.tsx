...
import EmailVerification from './_component/ForgotPassword';
    ...
    <div className="relative min-h-screen flex items-center justify-center bg-gray-100">
      ...
      {showWelcome ? (
        ...
        <div className="relative z-10 w-full max-w-md mx-auto">
          ...
          {showDiv.forgot && (
            <EmailVerification
              onCancel={() => setShowDiv({ ...showDiv, forgot: false, login: true })}
              onContinue={() => setShowDiv({ ...showDiv, forgot: false, password: true, login: false })}
              onVerificationComplete={(email, code) => {
                console.log('Verification complete:', email, code);
                setShowDiv({ ...showDiv, forgot: false, password: true, login: false });
              }}
            />
          )}
