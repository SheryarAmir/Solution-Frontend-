...
type DocumentActionCellRendererProps = {
  data: {
    id: string | number;
    [key: string]: any;
  };
...
const DocumentActionCellRenderer: React.FC<DocumentActionCellRendererProps> = ({ data, context }) => {
  const viewDocument = () => {
...
export default DocumentActionCellRenderer;
